    ...
    def execute(self, context):
        ...
        if append_arp:
            if scn.arp_smart_type == 'BODY':
                ...
                scn.arp_fingers_to_detect = 'NONE'
...
def _match_ref(self):
    ...
    if scn.arp_smart_type == 'BODY':
        ...
        for used_side in used_sides:
            ...
            if scn.arp_fingers_to_detect != 'NONE' and get_object("middle_bot" + used_side + "_auto") != None:
            ...
            if scn.arp_fingers_to_detect != 'NONE':
            ...
            if scn.arp_fingers_to_detect == 'NONE' or not found_fingers_loc:
...
###########  REGISTER  ##################
custom_icons = None
classes = (ARP_OT_facial_setup, ARP_OT_cancel_facial_setup, ARP_OT_restore_markers, ARP_OT_turn, ARP_OT_get_selected_objects, ARP_OT_go_detect, ARP_OT_markers_fx, ARP_OT_add_marker, ARP_OT_delete_detected, ARP_OT_cancel_and_delete_markers, ARP_PT_proxy_utils_ui, bone_transform, markers_transform, facial_markers_transform)#ARP_OT_smart_find_armatures)
