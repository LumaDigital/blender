...
class AnimLayersSettings(bpy.types.PropertyGroup):
    ...
    mergefcurves: bpy.props.BoolProperty(name="Merge Cyclic & Fcurve modifiers", description="Include Fcurve modifiers in the bake", default=False, options={'HIDDEN'}, override = {'LIBRARY_OVERRIDABLE'})
...
def register():
    ...
    #bpy.types.Scene.Anim_Layers = bpy.props.CollectionProperty(type = AnimLayersInfluence, options={'ANIMATABLE'},  override = {'LIBRARY_OVERRIDABLE', 'USE_INSERTION'})
