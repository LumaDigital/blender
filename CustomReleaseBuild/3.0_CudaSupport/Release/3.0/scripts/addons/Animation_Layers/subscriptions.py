...
def update_action(obj, anim_data):
    ...
    if obj.Anim_Layers[obj.als.layer_index].lock:
        return
    if anim_data.action == anim_data.nla_tracks[obj.als.layer_index].strips[0].action and anim_data.action == anim_data.nla_tracks[-1].strips[0].action:
        return
